...
[![GitHub](https://img.shields.io/static/v1?label=Code\&message=GitHub\&color=blue\&style=flat-square)](https://github.com/leomaurodesenv/game-datasets) ⭐ 1,106 | 🐛 2 | 📅 2026-08-08
[![CC-BY-4.0 license](https://img.shields.io/static/v1?label=License\&message=CC-BY-4.0\&color=blue\&style=flat-square)](LICENSE)
[![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/leomaurodesenv/game-datasets/continuous-integration.yml?label=Build\&style=flat-square)](https://github.com/leomaurodesenv/game-datasets/actions/workflows/continuous-integration.yml) ⭐ 1,106 | 🐛 2 | 📅 2026-08-08
...
This repository guides work with **Artificial Intelligence** or **Data Mining** in digital games. Find datasets, tools, and materials to build your *application* or *dataset*.
...
* [smm-course-viewer](https://github.com/leomaurodesenv/smm-course-viewer) ⭐ 18 | 🐛 1 | 🌐 JavaScript | 📅 2019-05-06 - Read courses from Super Mario Maker saves.
...
* [smm-maker-profile](https://github.com/leomaurodesenv/smm-maker-profile) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2023-04-20 - Fetch the user profile from Super Mario Maker game.
* [Counter-Strike](https://github.com/pnxenopoulos/csgo) ⭐ 0 | 🐛 0 | 📅 2022-02-04 - data parsing for Counter-Strike: Global Offensive (CSGO).
...
* [Malmo](https://github.com/Microsoft/malmo) ⭐ 4,270 | 🐛 171 | 🌐 Java | 📅 2025-09-03 - Platform built on top of [Minecraft](https://www.minecraft.net/en-us/) game.
...
* [Dungeon Crawl: Stone Soup](https://github.com/crawl/crawl) ⭐ 2,955 | 🐛 434 | 🌐 C++ | 📅 2026-08-16 - Roguelike adventure.
* [Visual Doom AI Competition](https://github.com/mwydmuch/ViZDoom) ⭐ 2,058 | 🐛 39 | 🌐 C++ | 📅 2026-08-13 - Doom game competition.
* [CyberBattleSim](https://github.com/microsoft/CyberBattleSim) ⭐ 1,784 | 🐛 19 | 🌐 Jupyter Notebook | 📅 2026-04-21 - Experimentation platform to investigate automated agents. [Website](https://www.microsoft.com/en-us/research/project/cyberbattlesim/).
* [qengine](https://github.com/klaussilveira/qengine) ⭐ 885 | 🐛 5 | 🌐 C | 📅 2026-04-09 - Retro game engine.
* [Wargus](https://github.com/Wargus/wargus) ⭐ 427 | 🐛 61 | 🌐 C | 📅 2026-06-29 - Real-time strategy game. [Website](https://wargus.github.io/).
* [microRTS](https://github.com/santiontanon/microrts) ⭐ 359 | 🐛 4 | 🌐 Java | 📅 2025-08-11 - RTS game competition. [PT-BR](https://github.com/rubensolv/MicroRTS) ⭐ 5 | 🐛 2 | 🌐 Java | 📅 2021-06-08.
* [polyworld](https://github.com/polyworld/polyworld) ⭐ 209 | 🐛 3 | 🌐 C++ | 📅 2025-09-21 - Artificial life system.
...
* [Showdown AI Competition](https://github.com/scotchkorean27/showdownaiclient) ⭐ 16 | 🐛 2 | 🌐 JavaScript | 📅 2018-01-18 - Competition of Pokemon battle.
* [MiniDungeons](https://github.com/sentientdesigns/minidungeons) ⭐ 9 | 🐛 0 | 🌐 Java | 📅 2017-06-07 - Procedural dungeon-like game.
* [Vindinium](https://github.com/leomaurodesenv/vindinium) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2019-03-05 - Multi-player turn based on roguelike competition. [Documentation](https://pythonhosted.org/vindinium/).
...
* [Shattered Pixel Dungeon](https://github.com/00-Evan/shattered-pixel-dungeon) ⭐ 6,428 | 🐛 11 | 🌐 Java | 📅 2026-08-15 - Improved Pixel Dungeon.
* [Pixel Dungeon](https://github.com/watabou/pixel-dungeon) ⭐ 3,939 | 🐛 58 | 🌐 Java | 📅 2019-07-23 - Roguelike game.
* [Habitica](https://github.com/HabitRPG/habitica-android) ⭐ 1,813 | 🐛 12 | 🌐 Kotlin | 📅 2026-08-16 - Gamify your life.

### Web

* [Duck Hunt](https://github.com/MattSurabian/DuckHunt-JS) ⭐ 630 | 🐛 14 | 🌐 JavaScript | 📅 2026-06-30 - Shooting game in ducks. [Play](http://duckhuntjs.com/).
* [Infinite Mario Bros](https://github.com/robertkleffner/mariohtml5) ⭐ 525 | 🐛 18 | 🌐 JavaScript | 📅 2022-12-06 - Super Mario Bros. [Play](https://openhtml5games.github.io/games-mirror/dist/mariohtml5/main.html).
...
* [The Quick, Draw! Dataset](https://github.com/googlecreativelab/quickdraw-dataset) ⚠️ Archived - Collection of 50 million drawings across 345 categories.
...
* [Pokémon GO Pokédex](https://github.com/Biuni/PokemonGO-Pokedex) ⭐ 133 | 🐛 1 | 📅 2017-01-28 - Encyclopedia Pokemon.
...
* [GamingVideoSET](https://github.com/NabajeetBarman/GamingHDRVideoSET) ⭐ 6 | 🐛 0 | 📅 2025-05-08 - A Dataset for Gaming Video Streaming Applications. [Paper](https://ieeexplore.ieee.org/document/8463362)
...
* [Steam Review Datasets](https://github.com/mulhod/steam_reviews) ⭐ 45 | 🐛 0 | 📅 2015-11-17 - Steam user reviews.
...
* [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 3,102 | 🐛 13 | 📅 2026-07-07 - Collection of open-source games.
* [Games of Coding](https://github.com/michelpereira/awesome-gamesofcoding) ⭐ 2,140 | 🐛 6 | 📅 2026-03-25 - Games to teach programming language.
* [Awesome ACG](https://github.com/soruly/awesome-acg) ⭐ 1,467 | 🐛 2 | 📅 2026-07-15 - Technologies related to anime, comic and games.
* [Awesome Esports](https://github.com/strift/awesome-esports) ⭐ 106 | 🐛 2 | 📅 2025-06-10 - Competitiosn using video games.
